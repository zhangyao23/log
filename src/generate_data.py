...
功能说明:
- 生成符合IEEE 802.11标准的WiFi事件日志
- 包含6种主要断连原因（reason code 1,3,4,5,15,23）
- 生成至少500条事件，8个不同客户端设备
- 输出文件：../ussawifievent_optimized.txt
...
重要区别:
- reason=[数字]: 配置变更原因 (不分析)
- reason code=[数字]: 断连原因 (分析重点)
"""
